...
- Naive Bayes (`"nbayes"`)
- Multinomial Classification using an L1-penalty (`"lasso"`), L2-penalty (`"ridge"`), or no penalty (`"multinom_glm"`)^2^
...
2. https://cran.r-project.org/web/packages/glmnet/vignettes/glmnet_beta.pdf
2. https://topepo.github.io/caret/recursive-feature-elimination.html
3. Pihur, Vasyl, Susmita Datta, and Somnath Datta. "RankAggreg, an R package for weighted rank aggregation." *BMC bioinformatics* 10.1 (2009): 62.
