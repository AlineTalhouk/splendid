...
- Shrinkage Linear Discriminant Analysis (`"slda"`)^3^
- Shrinkage Diagonal Discriminant Analysis (`"sdda"`)^3^
- Random Forests (`"rf"`)
...
3. Ahdesmäki, Miika, and Korbinian Strimmer. "Feature selection in omics prediction problems using cat scores and false nondiscovery rate control." *The Annals of Applied Statistics* 4.1 (2010): 503-519.
