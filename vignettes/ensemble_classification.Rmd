...
- `standardize`: whether to standardize the training set before classification and the test set (using training set centers & standard deviations) during prediction
